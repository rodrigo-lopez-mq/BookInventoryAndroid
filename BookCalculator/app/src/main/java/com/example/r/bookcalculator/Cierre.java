...
public class Cierre extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_cierre, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        TextView tv1 = (TextView) findViewById(R.id.editText77);
        TextView tv2 = (TextView) findViewById(R.id.editText78);
        TextView tv3 = (TextView) findViewById(R.id.editText79);
        TextView tv4 = (TextView) findViewById(R.id.editText76);
        TextView tv5 = (TextView) findViewById(R.id.editText84);
        TextView tv6 = (TextView) findViewById(R.id.editText80);
        TextView tv7 = (TextView) findViewById(R.id.editText85);

        TextView tv8 = (TextView) findViewById(R.id.editText81);
        TextView tv9 = (TextView) findViewById(R.id.editText82);
        TextView tv10 = (TextView) findViewById(R.id.editText83);
        TextView tv11 = (TextView) findViewById(R.id.editText86);
        TextView tv12 = (TextView) findViewById(R.id.editText87);
        TextView tv13 = (TextView) findViewById(R.id.editText88);
        TextView tv14 = (TextView) findViewById(R.id.editText89);
        ...
        if (id == R.id.save) {
            ...
            i.putExtra(Intent.EXTRA_SUBJECT, "Cierre: "+"" +" "+date);
